...
class PhysicsInformedNN:
    ...
    def train(self, nIter):
        ...
        self.loss_history = np.zeros(200000 + 1)  # 1 extra as a marker of where it switches between the optimizers
...
if __name__ == "__main__":
    ...
    if load_existing_model:
        ...
        loss_history_file_nametag = 'working'
        np.savetxt('loss_history_{}_{}_{}.dat'.format(number_of_training_iterations, 'none',
